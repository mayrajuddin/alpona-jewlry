                    ...
                    <div className="">
                        <ul className='menu-horizontal items-center capitalize'>
                            <li className="inline-block mr-3">
                                <a href="#" className="hover:text-[#FF8E97] duration-500">
                            ...
                            <li>
                                <div className="dropdown dropdown-hover dropdown-end py-2 text-sm">
                                    <label tabindex="0" className="cursor-pointer hover:text-[#FF8E97] duration-500">
                                        My Account
                                    ...
                                    <ul tabindex="0" className="dropdown-content menu p-2 shadow bg-base-100 rounded-md w-52 capitalize">
                                        <li><a className='w-full hover:text-[#FF8E97] duration-500 bg-transparent'>profile</a></li>
                                        <li><a className='w-full hover:text-[#FF8E97] duration-500 bg-transparent'>Cart</a></li>
                                        <li><a className='w-full hover:text-[#FF8E97] duration-500 bg-transparent'>Logout</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
